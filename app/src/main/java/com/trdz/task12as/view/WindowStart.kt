...
import com.trdz.task12as.base_utility.EFFECT_RISE
import com.trdz.task12as.databinding.FragmentWindowStartBinding
import com.trdz.task12as.view.segment_users.WindowUserList
...
class WindowStart: Fragment() {
	...
	private fun createMainWindow() {
		Handler(Looper.getMainLooper()).postDelayed({
			executors.getNavigation().replace(requireActivity().supportFragmentManager,WindowUserList(),false,effect = EFFECT_RISE)
		}, 100L)
	}
